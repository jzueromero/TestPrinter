...
namespace TestPrinter.Servicios
{
    //heredamos de PrintDocument
    public class ImpresorHelperClass : System.Drawing.Printing.PrintDocument
    {
        ...
        /// </summary>
        /// <remarks></remarks>
        public ImpresorHelperClass() : base()
        {
            //Set the file stream
        ...
        /// <remarks></remarks>
        public ImpresorHelperClass(string str) : base()
        {
            //Set the file stream
